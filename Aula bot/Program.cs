...
string lineas, temporal, aveces = "", cmp = "", texto2 = "", tareas_diferencias = "", texto = "", fechas_aula, fechas_aula2 = "", eventos_aula, fechaderemplazo = "", Admins = "", texto22 = "", fecha_actual = "", fecha_temp;
...
const string path_tareas = "E:\\Codigosd\\Aula bot\\Eventos.txt";
const string path_ip = "E:\\Codigosd\\Aula bot\\ips2.txt";
const string path_fecha = "E:\\Codigosd\\Aula bot\\Fechas.txt";
const string path_suscritos = "E:\\Codigosd\\Aula bot\\Suscritos2.txt";
const string path_admins = "E:\\Codigosd\\Aula bot\\Admins.txt";
const string path_datosOr = "E:E:\\Codigosd\\Aula bot\\DatosOr.txt";
const string path_datosOrTemp = "E:\\Codigosd\\Aula bot\\DatosOrTemp.txt";
const string path_datosOrLDI = "E:\\Codigosd\\Aula bot\\DatosOrLDI.txt";
const string path_suscritosLDI = "E:\\Codigosd\\Aula bot\\SuscritosLDI.txt";
const string path_datosOrTempLDI = "E:\\Codigosd\\Aula bot\\DatosOrTempLDI.txt";
const string path_fecha_LDI = "E:\\Codigosd\\Aula bot\\Fechas_LDI.txt";
const string path_tareas_LDI = "E:\\Codigosd\\Aula bot\\Eventos_LDI.txt";
const string path_tareas_ici2 = "E:\\Codigosd\\Aula bot\\EventosICI2.txt";
const string path_fechas_ici2 = "E:\\Codigosd\\Aula bot\\FechasICI2.txt";
const string path_suscritos_ici2 = "E:\\Codigosd\\Aula bot\\SuscritosICI2.txt";
const string path_datosOrICI2 = "E:\\Codigosd\\Aula bot\\DatosOrICI2.txt";
...
void aula(string path, string Usuario, string Password2, string fecha1,string tarea1)
{
    saberes = 0;
    contador_uni = 0;
    texto22 = "";
    ...
    fecha_temp = thisDay.ToString();
    fecha[0] = fecha_temp[0];
    fecha[1] = fecha_temp[1];
    ...
    foreach (var item2 in fecha_tareas)
    {
        if (new[] { '1', '2', '3', '4', '5', '6', '7', '8', '9' }.Any(x => item2.Text.Contains(x)))
        {
            if (!item2.Text.Contains("Sin eventos") && !item2.Text.Contains("Omitir"))
            {
                ...
                {
                    fechita[0] = item2.Text.ToString()[0];
                    fechota += fechita[0];
                    saberes += Int32.Parse(fechota);
                    fechota = "";
                }
            }
            fechaderemplazo = "";
...
bool revision(string lolo, string chavo)
{
    tareas_diferencias = "";
    contador_original = 0;
    contador_temporal = 0;
    switch (lolo)
    {
        case path_datosOr:
            ...
            aula(path_datosOrTemp,usuarioICI,contrasenaICI,path_fecha,path_tareas);
            break;
        case path_datosOrLDI:
          
            aula(path_datosOrTempLDI,usuarioLDI,contrasenaLDI,path_fecha_LDI,path_tareas_LDI);
            break;
        case path_datosOrICI2:
            aula(path_datosOrTempICI2, usuarioICI2, contrasenaICI2, path_fechas_ici2, path_tareas_ici2);
            break;
    }
...
ProcessStartInfo psi = new()
{
    ...
    WorkingDirectory = "E:\\Escritorio\\Server ICI\\",
    CreateNoWindow = false,
    FileName = "E:\\Escritorio\\Server ICI\\a.bat"
};
...
while (true)
{
    ...
    if (contadorcito % 7200 == 0)
    {
        ...
        if (revision(path_datosOr,path_datosOrTemp) == true)
        {
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
        ...
        if(revision(path_datosOrLDI,path_datosOrTempLDI) == true)
        {
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
        ...
        if (revision(path_datosOrICI2, path_datosOrTempICI2)==true)
        {
            ...
            if (update.Message != null)
            {
                ...
                switch (update.Message.Text)
                {
                    ...
                    case "/cmp_LDI":
                        ...
                        revision(path_datosOrLDI, path_datosOrTempLDI);
                    ...
                    case "/aula_LDI":
                        ...
                        if (LDI != true )
                        {
                            aula(path_datosOrLDI,usuarioLDI,contrasenaLDI,path_fecha_LDI,path_tareas_LDI);
                            LDI = true;
                        ...
                        if (aiuda2 != null)
                        {
                            ...
                            {
#pragma warning disable CS8604 // Posible argumento de referencia nulo
                                bot.SendMessage(update.Message.Chat.Id, aiuda2.ReadLine());
#pragma warning restore CS8604 // Posible argumento de referencia nulo
                            }
                            bot.SendMessage(update.Message.Chat.Id, "=============================\n");
                            aiuda2.Close();
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
                    ...
                    case "/cmp_ICI2":
                        bot.SendMessage(update.Message.Chat.Id, "Esta en proceso de comparacion manual\n");
                        revision(path_datosOrICI2, path_datosOrTempICI2);
                            if (tareas_diferencias.Length > 0)
                            {
                                bot.SendMessage(update.Message.Chat.Id, tareas_diferencias);
                            }
                    ...
                    case "/aula_ICI2":
                        ...
                        if (altiro != true)
                        {
                            aula(path_datosOrICI2, usuarioICI2, contrasenaICI2, path_fechas_ici2, path_tareas_ici2);
                            altiro = true;
                            conta = supercontador;
                        }
                        ...
                        if (aiu != null)
                        {
                            ...
                            {
#pragma warning disable CS8604 // Posible argumento de referencia nulo
                                bot.SendMessage(update.Message.Chat.Id, aiu.ReadLine());
#pragma warning restore CS8604 // Posible argumento de referencia nulo
                            }
                            bot.SendMessage(update.Message.Chat.Id, "=============================\n");
                            aiu.Close();
...
#pragma warning restore CS8602 // Desreferencia de una referencia posiblemente NULL.
                    ...
                    case "/cmp_ICI":
                        bot.SendMessage(update.Message.Chat.Id, "Esta en proceso de comparacion manual\n");
                        revision(path_datosOr, path_datosOrTemp);
                            if (tareas_diferencias.Length > 0)
                            {
                                bot.SendMessage(update.Message.Chat.Id, tareas_diferencias);
                            }
                    ...
                    case "/aula_ICI":
                        ...
                        if (veces != true)
                        {
                            aula(path_datosOr, usuarioICI, contrasenaICI, path_fecha, path_tareas);
                            veces = true;
                        ...
                        if (aiuda != null)
                        {
                            ...
                            {
#pragma warning disable CS8604 // Posible argumento de referencia nulo
                                bot.SendMessage(update.Message.Chat.Id, text: aiuda.ReadLine());
#pragma warning restore CS8604 // Posible argumento de referencia nulo
                            }
                            bot.SendMessage(update.Message.Chat.Id, "=============================\n");
                            aiuda.Close();
